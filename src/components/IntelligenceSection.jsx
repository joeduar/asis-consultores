    ...
    <div ref={ref} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: isMobile ? '0.4rem' : '0.75rem' }}>
      <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`}>
        <circle cx={cx} cy={cx} r={radius} fill="none"
          stroke="rgba(255,255,255,0.04)" strokeWidth={isMobile ? 5 : 6}/>
        <circle cx={cx} cy={cx} r={radius} fill="none"
          stroke={color} strokeWidth={isMobile ? 5 : 6} strokeLinecap="round"
          strokeDasharray={circumference}
          strokeDashoffset={animated ? offset : circumference}
          transform={`rotate(-90 ${cx} ${cx})`}
          style={{ transition: `stroke-dashoffset 1.8s cubic-bezier(0.4,0,0.2,1) ${delay}ms` }}
        />
        <text x={cx} y={cx - (isMobile ? 4 : 5)} textAnchor="middle" dominantBaseline="central"
          fill="white" style={{ fontSize: isMobile ? '14px' : '17px', fontFamily: "'Outfit',sans-serif", fontWeight: 600 }}>
          {animated ? `${percentage}%` : '0%'}
        </text>
        <text x={cx} y={cx + (isMobile ? 10 : 11)} textAnchor="middle" dominantBaseline="central"
          fill={color} style={{ fontSize: isMobile ? '6px' : '7px', fontFamily: "'Outfit',sans-serif", fontWeight: 700, letterSpacing: '0.1em' }}>
          {sublabel}
        </text>
      </svg>
      <span style={{
        fontSize: isMobile ? '0.52rem' : '0.58rem', color: '#94a3b8', textAlign: 'center',
  ...
  <div style={{
    ...
    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', minWidth: 0, flex: 1 }}>
        ...
        <span style={{
          fontSize: '0.65rem', color: highlight ? '#ffffff' : '#94a3b8',
    ...
    <section id="inteligencia" ref={sectionRef} style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: isMobile ? '2.5rem' : '4rem' }} data-aos="fade-up">
          ...
          <h2 style={{
            fontSize: isMobile ? 'clamp(1.4rem,7vw,1.9rem)' : 'clamp(1.8rem, 3vw, 2.8rem)',
          ...
          <p style={{ fontSize: '0.8rem', color: '#64748b', maxWidth: '540px', margin: '0 auto', lineHeight: 1.8, fontWeight: 300 }}>
        ...
        {/* Row 1: KPIs + Barras — 1 col mobile, 2 col desktop */}
        <div style={{
          display: 'grid',
          ...
          <div data-aos="fade-up" data-aos-delay="100"
            style={{ ...cardBase, padding: isMobile ? '1.5rem' : '2.5rem', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            <span style={{ fontSize: '0.6rem', color: '#a855f7', fontWeight: 700,
              textTransform: 'uppercase', letterSpacing: '0.2em', marginBottom: '0.4rem' }}>
              KPIs Operativos
            </span>
            <h3 style={{ fontSize: isMobile ? '0.9rem' : '1rem', fontWeight: 300, color: '#ffffff',
              textTransform: 'uppercase', letterSpacing: '0.15em', marginBottom: isMobile ? '1.25rem' : '2rem', textAlign: 'center' }}>
              Métricas de Rendimiento
            </h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: isMobile ? '0.5rem' : '1.5rem', width: '100%' }}>
          ...
          <div data-aos="fade-up" data-aos-delay="200"
            style={{ ...cardBase, padding: isMobile ? '1.25rem' : '2.5rem', display: 'flex', flexDirection: 'column' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1.5rem', flexWrap: 'wrap', gap: '0.5rem' }}>
              <div>
                ...
                <h3 style={{ fontSize: isMobile ? '0.95rem' : '1rem', fontWeight: 600, color: '#ffffff', margin: 0, letterSpacing: '0.05em' }}>
                  Recaudación Anual
                </h3>
              </div>
              <div style={{
                ...
                background: 'rgba(242,166,44,0.10)', border: '1px solid rgba(242,166,44,0.25)',
                flexShrink: 0,
              }}>
        ...
        {/* Row 2: Power BI features + live metrics — 1 col mobile, 2fr 1fr desktop */}
        <div style={{
          display: 'grid',
          ...
          <div data-aos="fade-up" data-aos-delay="300"
            style={{ ...cardBase, padding: isMobile ? '1.25rem' : '2.5rem' }}>
            <div style={{ marginBottom: isMobile ? '1.25rem' : '1.75rem' }}>
              ...
              <h3 style={{ fontSize: isMobile ? '0.95rem' : '1rem', fontWeight: 600, color: '#ffffff', letterSpacing: '0.05em', margin: 0 }}>
          ...
          <div data-aos="fade-up" data-aos-delay="400"
            style={{ ...cardBase, padding: isMobile ? '1.25rem' : '2.5rem', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
        ...
        {/* Row 3: Asesoría Estratégica — 1 col mobile, 1fr 2fr desktop */}
        <div style={{ marginTop: '1.5rem' }} data-aos="fade-up" data-aos-delay="200">
          <div style={{
            ...
            <div>
              ...
              <p style={{ fontSize: '0.8rem', color: '#64748b', fontWeight: 300, lineHeight: 1.75 }}>
            ...
            {/* Right: 4 pillars — 1 col mobile, 2 col desktop */}
            <div style={{
              display: 'grid',
              ...
              {[
                ...
                >
                  ...
                  <div style={{ minWidth: 0 }}>
                    ...
                    <div style={{ fontSize: '0.68rem', color: '#64748b', fontWeight: 300, lineHeight: 1.6 }}>
                      {item.desc}
                    </div>
                  </div>
                </div>
