...
const EcosystemSection = () => {
  ...
  const mainTools = [
    ...
    },
    {
      ...
      desc: 'Los procesos más críticos y delicados del sistema se ejecutan de forma automática, sujetas a revision humana para filtro de confirmacion. Estados de cuenta bancarios, conciliación bancaria, reportes periódicos y protocolos internos — sin margen de error.',
  ...
  // ── Herramientas adicionales (grid pequeño) ──
  const extraTools = [
    {
      icon: '📊',
      color: '#f59e0b',
          ...
          {mainTools.map((tool, i) => (
            ...
            >
              ...
              <p style={{
                ...
                fontWeight: 300, lineHeight: 1.75, margin: 0, flexGrow: 1,
              }}>
                {tool.desc}
              </p>
                ...
                {tool.features.map((f, fi) => (
                  <div key={fi} style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    <div style={{
                      ...
                      background: tool.color, flexShrink: 0, opacity: 0.8,
                    }}/>
