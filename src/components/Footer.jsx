...
const Footer = () => {
  ...
  const contactActions = [
    ...
    {
      label: 'Email',
      display: 'contacto@asisconsultores.org',
      href: 'mailto:contacto@asisconsultores.org',
      color: '#a855f7',
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" style={{ width: 16, height: 16 }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div data-aos="fade-up">
            {/* Logo — padding extra para que no se corte el arco */}
            <div style={{ marginBottom: '2rem', paddingTop: '0.5rem', paddingLeft: '0.25rem', overflow: 'visible' }}>
              <AsisLogo size="large" />
            </div>
            ...
            <p style={{
              ...
              Software de recaudación inteligente, automatización de procesos
              e inteligencia de negocios para instituciones que buscan eficiencia real.
            </p>
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.75rem' }}>
                ...
                <div>
                  <span style={{
                    ...
                    color: '#3584E4', textTransform: 'uppercase',
                    letterSpacing: '0.2em', display: 'block', marginBottom: '0.2rem',
                  }}>
                    Sede
                  </span>
                  <span style={{ color: '#e2e8f0', fontWeight: 300, fontSize: '0.9rem' }}>
                    Caracas, Venezuela
                  </span>
                </div>
              </div>
              ...
              {contactActions.map((action, i) => (
                ...
                >
                  <div style={{
                    ...
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    flexShrink: 0, color: action.color,
                  }}>
                    {action.icon}
                  </div>
                  <div>
                    <div style={{
                      ...
                      color: action.color, marginBottom: '0.1rem',
                    }}>
                      {action.label}
                    </div>
                    <div style={{ fontSize: '0.82rem', color: '#e2e8f0', fontWeight: 300 }}>
                      {action.display}
                    </div>
                  </div>
                  <svg viewBox="0 0 24 24" fill="none" stroke={action.color} strokeWidth={2}
                    style={{ width: 14, height: 14, marginLeft: 'auto', opacity: 0.6 }}>
          ...
          <div data-aos="fade-up" data-aos-delay="100">
            <div style={{
              ...
              <div style={{ marginBottom: '2rem' }}>
                <p style={{
                  color: '#3584E4', fontSize: '0.6rem', fontWeight: 700,
              ...
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                ...
                <button
                  ...
                  onMouseLeave={e => { if (!submitted) e.currentTarget.style.background = submitted ? 'rgba(34,197,94,0.12)' : '#3584E4' }}
                >
                  {submitted ? (
                    <>
