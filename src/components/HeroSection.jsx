...
const HeroSection = () => {
  ...
  const title1 = useTypewriter('Inteligencia de', 60, 500, visible)
  const title2 = useTypewriter('Negocios', 55, 1300, visible)
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
            ...
            <div style={{
              ...
              <a href="#software" className="axioma-btn-outline">
                Ver Servicios
              </a>
            </div>
            ...
            <div style={{
              ...
              {[
                ...
                <div key={i} style={{ display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
                  <span style={{ color: '#3584E4', fontSize: '1.5rem', fontWeight: 700, lineHeight: 1 }}>
                    {stat.value}
                  </span>
