  ...
  return (
    <section ref={sectionRef} style={{
      ...
      <div style={{ position:'absolute', inset:0, pointerEvents:'none' }}>
        <div style={{ position:'absolute', top:'50%', right:0, transform:'translateY(-50%)', width:500, height:500, background:'radial-gradient(circle, rgba(53,132,228,0.07) 0%, transparent 70%)', borderRadius:'50%' }}/>
      </div>
      ...
      <div style={{
        ...
        <div className="hero-grid">
          ...
          <div style={{ display:'flex', flexDirection:'column', alignItems:'flex-start' }}>
            <h1 style={{ marginBottom:'1.5rem', padding:0 }}>
              <span style={{
                display:'block',
                fontSize:'clamp(2.2rem, 8vw, 4.2rem)',
                fontWeight:300, lineHeight:1.15,
                textTransform:'uppercase', letterSpacing:'0.06em', color:'#ffffff',
                opacity: visible?1:0, transform: visible?'translateY(0)':'translateY(16px)',
                transition:'all 0.7s ease-out 0.3s',
              }}>
                {title1.displayed}{!title1.done && <span className="typing-cursor"/>}
              </span>
              <span style={{
                display:'block',
                fontSize:'clamp(2.2rem, 8vw, 4.2rem)',
                fontWeight:400, lineHeight:1.15,
                textTransform:'uppercase', letterSpacing:'0.06em', color:'#3584E4',
                opacity: visible?1:0, transform: visible?'translateY(0)':'translateY(16px)',
                transition:'all 0.7s ease-out 1.3s',
              }}>
                {title2.displayed}{title1.done && !title2.done && <span className="typing-cursor"/>}
              </span>
              <span style={{
                display:'block',
                fontSize:'clamp(0.9rem, 3vw, 1.6rem)',
                fontWeight:300, letterSpacing:'0.18em',
                color:'rgba(255,255,255,0.30)', marginTop:'0.5rem',
            ...
            <p style={{
              color:'#9090a8', fontSize:'clamp(0.85rem, 2.5vw, 1rem)',
              maxWidth:'460px', lineHeight:1.8, fontWeight:300, marginBottom:'2rem',
              opacity: visible?1:0, transform: visible?'translateY(0)':'translateY(16px)',
            ...
            <div style={{
              ...
              <a href="#contacto" className="axioma-btn group">
                Agendar Reunión
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3"/>
                </svg>
              </a>
              <a href="#software" className="axioma-btn-outline">Ver Servicios</a>
            </div>
            ...
            <div style={{
              ...
              {[
                ...
                <div key={i} style={{ display:'flex', flexDirection:'column', gap:'0.25rem' }}>
                  <span style={{ color:'#3584E4', fontSize:'clamp(1.2rem,4vw,1.5rem)', fontWeight:700, lineHeight:1 }}>{stat.value}</span>
                  <span style={{ color:'#9090a8', fontSize:'0.6rem', letterSpacing:'0.2em', textTransform:'uppercase' }}>{stat.label}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="hero-globe" style={{
            ...
            <div style={{ position:'absolute', inset:0, display:'flex', alignItems:'center', justifyContent:'center', pointerEvents:'none' }}>
              <div style={{ width:340, height:340, background:'radial-gradient(circle, rgba(53,132,228,0.08) 0%, transparent 70%)', borderRadius:'50%' }}/>
            </div>
            ...
            <div style={{
              ...
              borderRadius:'0.75rem', padding:'0.75rem 1rem',
              animation:'floatTag 9s ease-in-out infinite', animationDelay:'3s',
            }}>
              <div style={{ display:'flex', alignItems:'center', gap:'0.75rem' }}>
